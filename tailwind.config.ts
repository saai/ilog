  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'artistic-gradient': 'linear-gradient(135deg, #e639ff 0%, #f97316 100%)',
        'artistic-gradient-light': 'linear-gradient(135deg, #fdeeff 0%, #ffedd5 100%)',
      },
      animation: {
      ...
      boxShadow: {
        'artistic': '0 8px 32px rgba(0, 0, 0, 0.1)',
