      ...
      <main className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="artistic-card p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-neutral-700">example@email.com</span>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-neutral-700">中国，北京</span>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-neutral-700">+86 138 0000 0000</span>
                </div>
              </div>
            ...
            {/* 联系表单 */}
            <div className="artistic-card p-8">
              <h2 className="text-2xl font-display font-semibold text-neutral-800 mb-6">发送消息</h2>
              ...
              <form className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-primary-500 text-white px-6 py-3 rounded-full font-medium hover:bg-primary-600 transition-all duration-300"
                >
                  发送消息
                </button>
              </form>
