      ...
      <main className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 space-y-4">
            ...
            <p className="text-muted-foreground text-lg">让我们一起交流想法</p>
          </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="text-foreground space-y-2">
                    <div className="font-medium">中国，北京</div>
                    <div className="text-muted-foreground">美国，硅谷</div>
                  </div>
                </div>
                ...
                <div>
                  <h3 className="text-lg font-display font-semibold mb-4 text-foreground">社交媒体</h3>
